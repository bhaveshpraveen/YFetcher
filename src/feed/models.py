...
class Video(models.Model):
    ...
    published_at = models.DateTimeField(_("Video Published At"), db_index=True, null=True)
...
class APIKey(models.Model):
    api_secret = models.CharField(_("API Key"), max_length=128, unique=True, db_index=True)
